    ...
    if song in playlist.songs:
        try:
            ...
            return jsonify(
                {
                    "success": False,
                    "error": "Could not delete song from playlist. Check the logs for more information.",
                }
            )
    else:
...
def playlist_export(playlist_id):
    ...
    try:
        ...
        return jsonify(
            {
                "success": False,
                "error": "Could not export playlist to TIDAL. Check the logs for more information.",
            }
        )
